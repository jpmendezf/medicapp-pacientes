...
import 'package:doctro/PaypalPaymentScreen.dart';
...
class _BookAppointmentState extends State<BookAppointment> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DropdownButtonFormField(
                                      ...
                                      validator: (dynamic value) => value == null
                                          ? getTranslated(context, bookAppointment_hospital_validator).toString()
                                          : null,
                                    ...
                                    DropdownButtonFormField(
                                      ...
                                      validator: (dynamic value) => value == null
                                          ? getTranslated(context, bookAppointment_sideEffects_validator).toString()
                                          : null,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: Palette.dash_line, borderRadius: BorderRadius.circular(10)),
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              getTranslated(context, bookAppointment_appointmentDate_hint).toString(),
                                        ...
                                        validator: (String? value) {
                                          if (value!.isEmpty) {
                                            return getTranslated(context, bookAppointment_appointmentDate_validator)
                                                .toString();
                                          }
                                          return null;
                                        },
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Text(
                                                      getTranslated(context, bookAppointment_appointmentTime_title)
                                                          .toString(),
                                                      style:
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                border: InputBorder.none,
                                                hintText:
                                                    getTranslated(context, bookAppointment_offerCode_hint).toString(),
                                                hintStyle: TextStyle(
                                                  fontSize: width * 0.04,
                                              ...
                                              validator: (String? value) {
                                                if (value!.isEmpty) {
                                                  return getTranslated(context, bookAppointment_offerCode_validator)
                                                      .toString();
                                                }
                                                return null;
                                              },
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) => StripePaymentScreen(
                            ...
                            appointmentFees:
                                "$newAppointmentFees" != "0.0" ? '$newAppointmentFees' : '$appointmentFees',
                            doctorId: id,
  ...
  void openCheckoutRazorPay() async {
    var map = {
      ...
      'amount':
          "$newAppointmentFees" != "0.0" ? num.parse('$newAppointmentFees') * 100 : num.parse('$appointmentFees') * 100,
      'name': '$businessName',
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    _paymentToken != "" && _paymentToken!.isNotEmpty
        ? callApiBook()
        : Fluttertoast.showToast(
            msg: getTranslated(context, bookAppointment_paymentNotComplete_toast).toString(),
            toastLength: Toast.LENGTH_SHORT);
  }
  ...
  beginPayment() async {
    final Flutterwave flutterwave = Flutterwave.forUIPayment(
      ...
      isDebugMode: isLiveKey == 1 ? false : true,
      ...
      if (response.success == true) {
        setState(() {
          ...
          if (discountType == "AMOUNT" && isFlat == 1) {
            ...
            newAppointmentFees =
                int.parse('$appointmentFees') >= prAmount || int.parse('$appointmentFees') >= minDiscount!
                    ? newAppointmentFees
                    : appointmentFees;
          }
        });
