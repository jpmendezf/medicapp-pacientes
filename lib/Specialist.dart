                                                                      ...
                                                                      setState(
                                                                        () {
                                                                          Fluttertoast.showToast(
                                                                            msg: getTranslated(
                                                                                    context, specialist_pleaseLogin_toast)
                                                                                .toString(),
                        ...
                        child: ListView(
                          ...
                          children: [
                            GridView.builder(
                              ...
                              scrollDirection: Axis.vertical,
                              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: 2, mainAxisSpacing: 0, childAspectRatio: 0.85),
                              itemBuilder: (context, index) {
                                favoriteDoctor.clear();
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Card(
                                          ...
                                          child: Container(
                                            margin:
                                                EdgeInsets.symmetric(vertical: width * 0.02, horizontal: width * 0.02),
                                            child: Column(
                                              children: [
                                                Stack(
                                                  children: [
