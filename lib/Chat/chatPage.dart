...
class ChatPageState extends State<ChatPage> {
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      chatProvider.sendNotification(content, widget.doctorToken, SharedPreferenceHelper.getString(Preferences.name)!,
          currentUserId, type, peerNickname, peerAvatar);
      listScrollController.animateTo(0, duration: const Duration(milliseconds: 300), curve: Curves.easeOut);
    } else {
      Fluttertoast.showToast(
          msg: getTranslated(context, nothing_to_send_toast).toString(), backgroundColor: Palette.dark_grey);
    }
  }
