...
class ChatProvider {
    ...
    try {
      final response = await http.post(
        ...
        headers: <String, String>{
          ...
          'Authorization':
              "key=AAAAzoqfuq8:APA91bHco_Pppirs8YRBiRSgbgY36YU7sDBEHVmy4B-xFlbo72d0lMybehx7Ykd_dSv4eyb6XAQDklaPVnDeftYMAvo_jI8ZEku-d0IVye1txcmO2vnwWJPlX7_qeDuRqw06a5zb5DCU",
        },
        body: jsonEncode(
          <String, dynamic>{
  ...
  Future<Stream<QuerySnapshot>> getChatRooms() async {
    ...
    return FirebaseFirestore.instance
        ...
        .where(FirestoreConstants.pathMessageCollection, arrayContains: myUsername)
        .snapshots();
  }
}
