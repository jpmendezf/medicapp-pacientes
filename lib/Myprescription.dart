                                          ...
                                          children: [
                                            Container(
                                              ...
                                              margin: EdgeInsets.only(
                                                  left: width * 0.02, top: width * 0.02, right: width * 0.02),
                                              child: Column(
                                                children: [
                                                  Text(
                                                    widget.doctorName!,
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Text(
                                                            days[index]! +
                                                                getTranslated(context, myPrescription_days).toString(),
                                                            style: TextStyle(
                                                              fontSize: width * 0.03,
                                                              color: Palette.grey,
                                                            ),
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (Platform.isAndroid) {
                                        ...
                                        final String currentTime = DateTime
                                            ...
                                            .toString();
                                        downloadFile('$pdfPath', 'Doctro$currentTime.pdf', "$outputDirectory")
                                            .whenComplete(
                                              () =>
                                              Fluttertoast.showToast(
                                                msg: getTranslated(context, myPrescription_downloadComplete_toast)
                                                    .toString(),
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: width * 0.03, fontWeight: FontWeight.bold, color: Palette.red),
                                      )
                                    ],
                                  ),
                                ),
