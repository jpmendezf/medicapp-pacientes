                      ...
                      children: [
                        ...
                        Container(
                          child: Text(
                            ...
                            style: TextStyle(
                                fontSize: width * 0.045, fontWeight: FontWeight.bold, color: Palette.dark_blue),
                          ),
                        ),
                        InkWell(
                          onTap: () {
                            ...
                            onTap: () {
                              setState(
                                () {
                                  if (isWhere == "Home") {
                                    _passAddress(
                                        showAddress[index].address, showAddress[index].lat, showAddress[index].lang);
                                    ...
                                    // int doctorId = int.parse(SharedPreferenceHelper.getString('doctorId')!);
                                    Navigator.pushReplacement(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => BookAppointment(
