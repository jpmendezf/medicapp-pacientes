      ...
      Future.delayed(
        ...
        () {
          ...
          homeProvider.updateDataFirestore(
              ...
              {'pushToken': SharedPreferenceHelper.getString(Preferences.notificationRegisterKey)!});
          print("MASSEGE TOKEN ${SharedPreferenceHelper.getString(Preferences.notificationRegisterKey)}");
        },
      );
    }
    if (SharedPreferenceHelper.getBoolean(Preferences.is_logged_in) == true) {
                                      ...
                                      FormHelper.showMessage(
                                        ...
                                        onPressed2: () {
                                          Preferences.checkNetwork()
                                              .then((value) => value == true ? logoutUser() : print('No int'));
                                        },
                                      );
                                    },
                                    child: Text(
                                                              ...
                                                              children: [
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      child: Text(
                                                                        getTranslated(context, home_bookingId)
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                            fontSize: 14,
                                                                            color: index % 2 == 0
                                                              ...
                                                              children: [
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      child: Text(
                                                                        getTranslated(context, home_dateTime)
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                          fontSize: 12,
                                                                          color: index % 2 == 0
                                                                    ...
                                                                    Container(
                                                                      child: Text(
                                                                        getTranslated(context, home_patientName)
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                          fontSize: 12,
                                                                          color: index == 0
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      child: Text(
                                                                        ...
                                                                        style: TextStyle(
                                                                            fontSize: 12, color: Palette.dark_blue),
                                                                      ),
                                                                    ),
                                                                    Container(
                                                                      child: Text(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            _searchResult[index].treatment != null
                                                                ...
                                                                : Text(
                                                                    getTranslated(context, home_notAvailable)
                                                                        .toString(),
                                                                    style: TextStyle(
                                                                        fontSize: width * 0.035, color: Palette.grey),
                                                                  ),
                                ...
                                : Center(
                                    child: Container(
                                      ...
                                      child: Text(
                                        getTranslated(context, home_notAvailable).toString(),
                                        style: TextStyle(
                                            fontSize: width * 0.05, color: Palette.grey, fontWeight: FontWeight.bold),
                                        textAlign: TextAlign.center,
                                      ),
                                    ),
                                  ),
        ...
        if (SharedPreferenceHelper.getBoolean(Preferences.is_logged_in) == true) {
          ...
          if (response.data!.flutterwaveEncryptionKey! != "null") {
            SharedPreferenceHelper.setString(
                Preferences.flutterWave_encryption_key, response.data!.flutterwaveEncryptionKey!);
          }
