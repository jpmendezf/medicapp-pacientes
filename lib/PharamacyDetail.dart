                                    ...
                                    children: [
                                      Container(
                                        child: Text(
                                          ...
                                          style:
                                              TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Palette.grey),
                                        ),
                                      ),
                                      Container(
                                        child: Text(
                                      ...
                                      children: [
                                        Container(
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                                fontSize: 14, fontWeight: FontWeight.bold, color: Palette.grey),
                                          ),
                                        ),
                                        Container(
                                          child: Text(
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                MedicineDescription(id: medicines[index].id),
                                                          ),
                                                        );
                                                      },
                                                      child: Container(
